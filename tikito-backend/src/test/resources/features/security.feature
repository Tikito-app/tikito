...
#      | WOLTERS KLUWER | 2026-05-24 | 5      | 12.5  | 10.5        |
  ...
  Scenario: Calculate performance for lots of cash changes
    ...
    When importing security transactions for user 1:
      ...
      | 1      | Test security account | WOLTERS KLUWER | 2025-01-02T10:01:20.0Z | 10     | -1    | EUR      | 1            | TRANSACTION_COST | 0    |
    ...
    Then historical security holding values persisted have:
      ...
      | 1      | WOLTERS KLUWER | Test security account | 2025-01-02 | 0      | 10    | -1          | 0             | 0                        | 0          | -1                    | -100              | 100                | 0     | -100            | 99         |
      | 1      | WOLTERS KLUWER | Test security account | 2025-01-03 | 10     | 10    | -0.99010    | 0             | 0                        | 0          | -1                    | -200              | 100                | 0     | -101            | 0          |
      | 1      | WOLTERS KLUWER | Test security account | 2025-01-04 | 10     | 20    | 100         | 0             | 0                        | 0          | -1                    | -200              | 100                | 100   | -101            | 0          |
      | 1      | WOLTERS KLUWER | Test security account | 2025-01-05 | 10     | 20    | 125         | 25            | 0                        | 0          | -1                    | -200              | 100                | 125   | -101            | 25         |
      | 1      | WOLTERS KLUWER | Test security account | 2025-01-06 | 10     | 20    | 120         | 25            | 0                        | -5         | -1                    | -200              | 100                | 120   | -101            | 20         |
      | 1      | WOLTERS KLUWER | Test security account | 2025-01-07 | 10     | 20    | 117         | 25            | 0                        | -5         | -4                    | -200              | 100                | 120   | -101            | 17         |
      | 1      | WOLTERS KLUWER | Test security account | 2025-01-08 | 10     | 20    | 113         | 25            | -4                       | -5         | -4                    | -200              | 100                | 116   | -101            | 13         |
