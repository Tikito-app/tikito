...
public class MoneyTransactionService {
    ...
    public MoneyTransactionService(final MoneyTransactionRepository moneyTransactionRepository,
        ...
        importers = List.of(
                new CustomHeaderListImporter(),
                new ABNExcelImporter(),
                new INGExcelImporter(),
                new ABNMT940Importer());
    }
    ...
    public void deleteTransaction(final long userId, final long transactionId) {
        ...
        jobService.addJob(Job.security(JobType.RECALCULATE_HISTORICAL_MONEY_VALUES, transaction.getAccountId(), userId).build());
        jobService.addJob(Job.security(JobType.RECALCULATE_AGGREGATED_HISTORICAL_MONEY_VALUES, userId).build());
    }
