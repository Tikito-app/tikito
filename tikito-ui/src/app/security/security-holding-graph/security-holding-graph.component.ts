  ...
  private getTooltip(holdingsValuePerDate: any, holdingsPerSecurityId: any) {
    return {
      ...
      formatter(params: any): any {
        ...
        return '<table>' +
          Object.values(holdingValue).map((holding: any) => {
            return `<tr><td>${date}</td><td><span style="float: right; margin-left: 20px;">${holdingsPerSecurityId[holding.securityId].security.name}</span></td></tr>` +
          `<tr><td>${getMarker(params, SecurityHoldingGraphDisplayField.PRICE)} Price * amount</td><td><span style="float: right; margin-left: 20px;">${Util.currencyFormatWithSymbol(holding.price, holding.currencyId)} * ${holding.amount}</span></td></tr>` +
              (holding.totalDividend == 0 ? '' : `<tr><td>${getMarker(params, SecurityHoldingGraphDisplayField.HOLDING_VALUE)} Current value</td><td><span style="float: right; margin-left: 20px; color: ${Util.currencyColor(holding.price * holding.amount)};">${Util.currencyFormatWithSymbol(holding.price * holding.amount, holding.currencyId)}</span></td></tr>`) +
              (holding.totalDividend == 0 ? '' : `<tr><td>${getMarker(params, SecurityHoldingGraphDisplayField.ADMIN_COST)} Admin costs</td><td><span style="float: right; margin-left: 20px; color: ${Util.currencyColor(holding.totalAdministrativeCosts)};">${Util.currencyFormatWithSymbol(holding.totalAdministrativeCosts, holding.currencyId)}</span></td></tr>`) +
              (holding.totalDividend == 0 ? '' : `<tr><td>${getMarker(params, SecurityHoldingGraphDisplayField.TAX)} Taxes</td><td><span style="float: right; margin-left: 20px; color: ${Util.currencyColor(holding.totalTaxes)};">${Util.currencyFormatWithSymbol(holding.totalTaxes, holding.currencyId)}</span></td></tr>`) +
            (holding.totalDividend == 0 ? '' : `<tr><td>${getMarker(params, SecurityHoldingGraphDisplayField.DIVIDEND)} Dividend</td><td><span style="float: right; margin-left: 20px; color: ${Util.currencyColor(holding.totalDividend)};">${Util.currencyFormatWithSymbol(holding.totalDividend, holding.currencyId)}</span></td></tr>`) +
          `<tr><td>${getMarker(params, SecurityHoldingGraphDisplayField.PERFORMANCE)} Performance</td><td><span style="float: right; margin-left: 20px; color: ${Util.currencyColor(SecurityUtil.getPerformance(holding))};">${Util.percentageFormat(SecurityUtil.getPerformance(holding))}</span></td></tr>` +
          '</table>';
      });
      }
    }
